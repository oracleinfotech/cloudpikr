...
const ProjectsDetails = () => {
    return (
        <>
            ...
            <PageBanner pageTitle="HR Management System" />
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <div className="project-details-image">
                                <img src="/images/moodle-hr-pics/hr1.PNG" alt="work" /> 
                            </div>
                        </div>

                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <div className="project-details-image">
                                <img src="/images/moodle-hr-pics/hr2.PNG" alt="work" />
                            </div>
                        </div>

                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <div className="project-details-image">
                                <img src="/images/moodle-hr-pics/hr3.PNG" alt="work" /> 
                            </div>
                        </div>

                        <div className="col-lg-6 col-md-6 col-sm-6">
                            <div className="project-details-image">
                                <img src="/images/moodle-hr-pics/hr4.PNG" alt="work" /> 
                            </div>
                        </div>
